...
import collabstackLogo from './assets/collabstack.png'
  ...
  export const projects = [
    {
      ...
      title: "CollabStack",
      description:
        "CollabStack is a full-stack SaaS platform that enables real-time, AI-assisted content collaboration. Designed for teams, freelancers, and creators, it combines live multiplayer editing, AI content generation, and a modular workspace environment. Users can create, edit, and share documents instantly—powered by Liveblocks for real-time synchronization and Google Generative AI (Gemini API) for intelligent writing assistance. The platform integrates Editor.js for block-based editing with support for tables, images, links, lists, and code blocks, along with emoji reactions and collaborative tools. With Clerk authentication, users can securely log in, join workspaces, and collaborate seamlessly across devices.",
      image: collabstackLogo,
      tags: ["React", "Next.js", "JavaScript", "Node.js", "Firebase", "Liveblocks", "Gemini API", "Clerk", "shadcn/ui", "Lucide React", "Editor.js + plugins", "GitHub", "Vercel", "REST API"],
      github: "https://github.com/princekrmishra/collabstack",
      webapp: "https://collabstack.vercel.app/",
    },
    {
      id: 1,
      title: "InstaSite",
